...
class Reflection {
	...
	void test() {
		...
		try {
			...
			p = cz.getPackage();
			System.out.println(cz.getModifiers() + "/" + cz.getName() + "/" + cz.getSimpleName() + "/" + p.getName()
					+ "/" + cz.getSuperclass());
...
//---------给属性赋值--------------------------------		
	...
	@Test
	void test3() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException,
