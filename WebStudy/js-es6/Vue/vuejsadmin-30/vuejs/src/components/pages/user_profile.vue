        ...
        <div class="col-xl-4 col-lg-5">
                                          ...
                                          <div class="row">
                                              <div class="col-12">
                                                  <div class="row">
                                                      ...
                                                      <div class="col-8 mt-2">user@example.com</div>
                                                      ...
                                                      <div class="col-8 mt-1">Westwood, 12th Street,7023 Mckinley Ave, US.</div>
                                                  </div>
                                              </div>
                                          </div>
                                    </b-tab>
            ...
            <b-card header="Project Details :" header-tag="h4" class="bg-success-card">
                <b-list-group class="project-deatails">
                    ...
                    <b-list-group-item>
                        <a href="#" class="text-success"> Submitted Projects <span class=" badge badge-success float-right">9</span></a>
                    </b-list-group-item>
                    <b-list-group-item>
                        <a href="#" class="text-warning"> Submitted Projects <span class="badge badge-warning float-right">9</span></a>
                    </b-list-group-item>
                    <b-list-group-item>
                        <a href="#" class="text-danger">In Progress <span class=" badge badge-danger float-right"> 11</span></a>
                    </b-list-group-item>
                    <b-list-group-item>
                        <a href="#" class="text-success"> Upcoming <span class="badge badge-success float-right">8</span></a>
                    </b-list-group-item>
                </b-list-group>
            </b-card>
        </div>
                        ...
                        <div class="row" id="blog">
                            <div class="col-xl-4 col-lg-6">
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        <p>
                                            <img src="~img/authors/avatar6.jpg" alt="author image" class="blog-image rounded-circle p-2 float-left img-fluid">
                                            <span class="post-by p-2"><strong>Jennie</strong> shared a post from <strong>Nature's</strong></span>
                                        </p>
                                        <img src="~img/pages/blog1.jpeg" alt="blog image2" class="sharedpost-image img-fluid">
                                    </div>
                                ...
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        <div>
                                            ...
                                            <img src="~img/pages/blog4.jpg" alt="blog image2" class="sharedpost-image img-fluid">
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="blog-border p-2">
                                    <div class="blog-heading ">
                                        <img src="~img/pages/blog2.png" alt="blog image2" class="sharedpost-image img-fluid">
                                    </div>
                                    <div class="blog-body p-2">
                                        <p>Lorem Ipsum is simply dummy, vidis litro abertis.</p>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        ...
                                        <img src="~img/pages/blog3.jpeg" alt="blog image2" class="attached-image img-fluid">
                                    </div>
                                </div>
                                <div class="blog-border">
                                    <div class="blog-heading">
                                        <p>
                                            <img src="~img/authors/avatar4.jpg" alt="author image" class="blog-image rounded-circle p-2 float-left">
                                            <span class="post-by">Post by <strong>John</strong></span>
                                        </p>
                                        <img src="~img/pages/profile-coverbg.jpeg" alt="blog image2" class="sharedpost-image img-fluid">
                                    </div>
                                    <div class="blog-body p-2">
                                        <p>Lorem Ipsum is simply dummy, vidis litro abertis. simply dummy, vidis litro abertis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
