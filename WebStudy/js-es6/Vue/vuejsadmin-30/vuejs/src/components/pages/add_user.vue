                        ...
                        <vue-form class="form-horizontal form-validation" :state="formstate" @submit.prevent="onSubmit">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <input v-model="model.email" name="email" id="email" type="email" required placeholder="E-mail" class="form-control" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <input v-model="model.mobile" name="mobile" id="mobile" type="mobile" required placeholder="Mobile Number(10 Digits)" class="form-control" pattern="[0-9]{10}" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <input name="dob" id="dob" type="date" required placeholder="Date of Birth" class="form-control" v-model="model.dob" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <input v-model="model.repeatPassword" id="repeatpassword" name="repeatpassword" type="password" required placeholder="Confirm Password" class="form-control" :sameas="model.password">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <validate tag="div">
                                                ...
                                                <input name="pin" id="pin" type="text" required placeholder="PIN" class="form-control" pattern="[0-9]{6}" v-model="model.pin" />
                            ...
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    <div class="checkbox">
                                        <validate tag="label">
                                            <b-form-checkbox v-model="model.terms" id="terms">
                                                    I agree the
                                                    <span>
