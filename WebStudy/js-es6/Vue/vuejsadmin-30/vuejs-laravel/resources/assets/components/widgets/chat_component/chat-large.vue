            ...
            <div class="converstion_back">
                <div class="chat_header" :class="bgColor">
                    ...
                    <div class="float-right">
                        ...
                        <label class="bg2"><input type="radio" :value="require('img/pages/chat_background2.jpeg')" v-model="bgColor" class="d-none"></label>
...
<style scoped lang="scss">
    ...
    .converstion_back {
        ...
        &>.chat_header {
            ...
            .bg2{
                background-image: url("~img/pages/chat_background2.jpeg");
            }
            .bg3{
