                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group p-10">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <div class="input-group-btn form_elemntsdropdown">
                                            ...
                                            <div class="input-group mt-3 drp_align">
                                                <input type="text" class="form-control">
                                                <div class="input-group-btn form_elemntsdropdown">
                                                    <b-dropdown text="Action">
                                                        <b-dropdown-header>This is a heading</b-dropdown-header>
                                    ...
                                    <div class="form-group p-10">
                                        ...
                                        <div class="col-md-8 col-md-offset-2">
                                            ...
                                            <div class="radio">
                                                <label class="custom-control custom-radio">
                                                    <input id="radioStacked2" name="radio-stacked" type="radio" class="custom-control-input" checked>
                                                    <span class="custom-control-indicator custom_checkbox_info"></span>
                                            ...
                                            <div class="radio">
                                                <label class="custom-control custom-radio disabled">
                                                    <input id="radioStacked3" name="radio-stacked" type="radio" class="custom-control-input" disabled>
