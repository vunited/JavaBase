        ...
        <v-scroll height="300px" color="#ccc" bar-width="3px" ref="task_scroller">
            <ul class="task_block1">
                ...
                <li v-for='(item,index) in value' :key="index" class="task_block">
                    ...
                    <div v-if="item.edit">
                        <input type="text" v-model="item.tname" @keyup.enter='save(item,index)'>
                        <span class="float-right ">
                            <i class="fa fa-save" @click='save(item,index)'></i> | <i class="fa fa-times text-danger" @click='cancel(item,index)'></i>
                        </span>
                    </div>
                </li>
            </ul>
