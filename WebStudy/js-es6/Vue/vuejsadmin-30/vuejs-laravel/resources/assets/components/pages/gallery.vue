...
export default {
    ...
    data() {
        return {
            list: [{
                src: require("img/pages/blog1.jpeg"),
                filter: "Landscape"
            }, {
                src: require("img/pages/blog2.png"),
                filter: "Studio"
            }, {
                src: require("img/pages/timeline1.jpeg"),
                filter: "Studio"
            }, {
                src: require("img/pages/blog3.jpeg"),
                filter: "Landscape"
            }, {
                src: require("img/pages/blog1.jpeg"),
                filter: "Studio"
            }, {
                src: require("img/pages/profile-coverbg.jpeg"),
                filter: "Landscape"
            }, {
                src: require("img/pages/blog2.png"),
                filter: "Studio"
            }, {
                src: require("img/pages/timeline.jpeg"),
                filter: "Studio"
            }, {
                src: require("img/pages/blog3.jpeg"),
                filter: "Studio"
