...
public class Demo {
	...
	public static void ip(String adfas[]) throws Exception {
		byte b[]=new ShowapiRequest("https://ali-ip.showapi.com/ip","appcode")
	...
	public static void 发送短信( ) throws Exception {
		...
		byte b[]=req
				.addTextPara("content", "1")
				.addTextPara("mobile", "1")
				.addTextPara("tNum", "1")
				.getAsByte();
		String str=new String(b,"utf-8");
		Map map = req.getRes_headMap();
	...
	public static void 违章(String adfas[]) throws Exception {
		...
		.addTextPara("carEngineCode", "BA40335")
		.addTextPara("carNumber", "陕AF426G")
	...
	public static void 图片验证( ) throws Exception {
		ShowapiRequest req = new ShowapiRequest(
				"http://ali-checkcode2.showapi.com/checkcode","appcode");
		byte img[]=WebUtils.readByteFromStream(new FileInputStream(new File("JAVA.png")));
		String base64string = new String(Base64.encode(img));  
		      System.out.println(base64string);  
		byte b[] = req.addTextPara("typeId","3000")
